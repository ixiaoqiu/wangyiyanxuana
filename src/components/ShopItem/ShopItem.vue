<template>
  <div class="Item">
    <img class="Iamge" :src="shopItem.newAppBanner ? shopItem.newAppBanner : shopItem.picUrl" alt="">
    <div class="title">{{shopItem.title}}</div>
    <div class="footer">
      <div class="user">
        <img :src="shopItem.avatar" alt="">
        <span>{{shopItem.nickname}}</span>
      </div>
      <div class="browse">
